  ...
  return (
    <div ref={el}>
      <div className="team-body">
        <div className="team-screen body-text">
        ...
        <div className="team-screen body-text team-one team-member">
        ...
        <div className="team-screen body-text team-two team-member">
          <p className="call-out">
            Oyinbobola Owojori
        ...
        <div className="team-screen body-text team-three  team-member">
          <p className="call-out">
            Arnold Adeyemi
        ...
        <div className="team-screen body-text team-four  team-member">
          <p className="call-out">
            Solomon Ndifereke
        ...
        <div className="team-screen body-text team-five  team-member">
          <p className="call-out">
            Eilya Amin
